...
<meta http-equiv='Content-Type' content='text/html; charset=UTF-8'>
    ...
    <title>Index of All LowPoly Backgrounds // Concepro Agency</title>
...
.p1 {background : linear-gradient(90deg, #4BC0C8, #C779D0, #FEAC5E) ; color: white ; text-transform: uppercase ; padding : 10px ; }
