...
echo "#################" #Blank line
ROOT="$HOME_WINDOWS/Dropbox/Public/_TO_SYNC_downloads.concepro.com/_BRAND-CONCEPRO/concepro-08-social/sharing"
echo "CURRENT WORKING DIRECTORY: " $ROOT ##check the present working directory
echo "#################" #Blank line

FINALFILENAME="Index-of-SocialMedia-files-BS.html"
...
<!-- Google tag (gtag.js) -->
<script async src='https://www.googletagmanager.com/gtag/js?id=G-7SE7GXFG99'></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-7SE7GXFG99');
</script>
...
div.heading {
    ...
    background : linear-gradient( 185deg, #007fff, #ff8700 ) ;
