#!/bin/bash
THIS_SCRIPT_NAME="1001-concepro-CREATE-AND-SAVE-SITE-STATISTICS.sh"
...
HUGO_CONTENT_DIR="$DIR_GITHUB/2020-CNCP/content"
FILE_OUTPUT_SITESTATS="$DIR_GITHUB/2020-CNCP/static/sitestats.html"
