#!/bin/bash
################################################################################
THIS_SCRIPT_NAME="1001-concepro-RENAME-ALL-MD-FILES-BASED-UPON-DATE-URL-YAML-FRONTMATTER-VALUES.sh"
################################################################################
...
## VARIABLE SETTING
################################################################################
HUGO_CONTENT_DIR="$DIR_GITHUB/2020-CNCP/content/blog" ;
#HUGO_CONTENT_DIR="$HOME/Desktop/Z/content"
OUTPUT_DIR="$HOME/Desktop/Y"
OUTPUT_HTML_FILE="$OUTPUT_DIR/_TMP_1001_OUTPUT_FILE.HTML"
OUTPUT_HTML_FILE_RENAMED_ONLY="$OUTPUT_DIR/_TMP_1001_OUTPUT_FILE_RENAMED_ONLY.HTML"
TMP_LOGFILE="$OUTPUT_DIR/_TMP_1001_LOGFILE.TXT"
...
BACKUP_ZIPFILE_NAME="$PWD/$BACKUP_DATE_PREFIX-BACKUP-of-2019-HUGO-CONCEPRO-WEBSITE-OFFICIAL-content-directory.zip"
