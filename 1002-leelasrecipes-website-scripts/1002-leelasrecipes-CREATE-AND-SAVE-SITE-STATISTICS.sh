...
echo "$MGGK_RECIPE_HERE_BUTTON_BLOCKS: NUMBER OF POSTS WITH RECIPE_HERE_BUTTON_BLOCKS" >> $FILE_OUTPUT_SITESTATS
...
NUM_CURRENT_ORIGINAL_COPIED_IMAGES=$(ls $HUGO_BASE_DIR/static/wp-content/rich-markup-images/original_copied/*.* | wc -l)
