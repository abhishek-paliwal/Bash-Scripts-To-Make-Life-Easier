#!/bin/bash
################################################################################
THIS_SCRIPT_NAME="1002-leelasrecipes-RENAME-ALL-MD-FILES-BASED-UPON-DATE-URL-YAML-FRONTMATTER-VALUES.sh"
################################################################################
...
OUTPUT_HTML_FILE="$OUTPUT_DIR/_TMP_1002_OUTPUT_FILE.HTML"
OUTPUT_HTML_FILE_RENAMED_ONLY="$OUTPUT_DIR/_TMP_1002_OUTPUT_FILE_RENAMED_ONLY.HTML"
TMP_LOGFILE="$OUTPUT_DIR/_TMP_1002_LOGFILE.TXT"
...
BACKUP_ZIPFILE_NAME="$PWD/$BACKUP_DATE_PREFIX-BACKUP-of-2020-LEELA-RECIPES-WEBSITE-OFFICIAL-content-directory.zip"
