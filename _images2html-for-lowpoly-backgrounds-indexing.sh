...
OUTPUT="$ROOT/all-lowpoly-backgrounds-index.html" ##Output filename
...
open -a Safari http://downloads.concepro.com/dropbox-public-files/all-polygonal-backgrounds/all-lowpoly-backgrounds-index.html
