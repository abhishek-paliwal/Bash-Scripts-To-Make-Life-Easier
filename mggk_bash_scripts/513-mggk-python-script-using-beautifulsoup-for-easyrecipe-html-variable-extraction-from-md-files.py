...
SUCCESS_FILE = OUTPUT_DIR+"/_TMP_CHECK_THIS_FILE_FOR_SUCCESS.CSV"
ERROR_FILE = OUTPUT_DIR+"/_TMP_CHECK_THIS_FILE_FOR_ERRORS.CSV"
FILELIST_USED = OUTPUT_DIR+"/_TMP_THIS_FILELIST_IS_USED.CSV"
