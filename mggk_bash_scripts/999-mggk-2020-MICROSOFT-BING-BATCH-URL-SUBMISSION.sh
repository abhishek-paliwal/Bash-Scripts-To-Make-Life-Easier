...
## API VARIABLES
API_FILEPATH="$HOME/Dropbox/docs_encrypted/IT-usernames-passwords-server-details/__PALIS_PRIVATE_KEYS_AND_CONFIGS_unencrypted/202010-bing-webmaster-api-key.txt" ;
