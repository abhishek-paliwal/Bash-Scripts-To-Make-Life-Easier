...
func_step2_find_all_internal_inbound_links_for_each_mdfile_url "$inFile0" "$PREFIX_ALLMGGKURLS" ;
#######
## CALLING FUNC_3
...
func_step3_find_all_internal_outbound_links_in_each_mdfile "$inFile0" "$PREFIX_ALLMGGKURLS" ;
#######
