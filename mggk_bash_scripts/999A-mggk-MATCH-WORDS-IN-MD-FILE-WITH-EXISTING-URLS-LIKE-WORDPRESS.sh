...
USAGE: $(basename $0)
    ...
    ################################################################################
    ## REQUIREMENT: Make sure to rename your text file with prefix 'recipe' ...
...
echo "<p>File autogenerated by script: $THIS_SCRIPT_NAME</p>" >> $FILE_FINAL
echo "<p>File autogenerated at: $(date)</p>" >> $FILE_FINAL
echo "<hr>" >> $FILE_FINAL
