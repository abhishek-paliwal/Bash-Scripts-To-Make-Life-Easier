...
OUTPUT_DIR="$HOME/Dropbox/Public/_TO_SYNC_downloads.concepro.com/dropbox-public-files/LCE/_pali_github_scripts_outputs" ;
OUTPUT_HTML="$OUTPUT_DIR/TMP_OUTPUT_HTML_$SCRIPT_NAME_SANS_EXTENSION.html" ;
