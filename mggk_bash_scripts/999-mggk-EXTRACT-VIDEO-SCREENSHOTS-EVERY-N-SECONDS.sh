...
USAGE: $(basename $0)
  ###############################################################################
  ## IF YOU CHOOSE OPTION 1 => THIS PROGRAM EXTRACTS VIDEO THUMBNAIL SCREENSHOTS FROM
  ...
  ####
  ## IF YOU CHOOSE OPTION 2 => THIS PROGRAM RENAMES STEP IMAGES SEQUENTIALLY, ACCORDING
