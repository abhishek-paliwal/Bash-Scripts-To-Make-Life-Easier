...
echo "#################" #Blank line
DIRPATH="$REPO_MGGK/static/wp-content/recipe-steps-images"
...
FINALFILENAME="index-recipe-steps-images.html"
OUTPUT="$DIRPATH/$FINALFILENAME" ##Output filename
SITEURL="https://www.mygingergarlickitchen.com/$FINALFILENAME"
...
<meta http-equiv='Content-Type' content='text/html; charset=UTF-8'>
    ...
    <title>Index of MGGK - Recipe Steps Images</title>
