...
echo;
/home/linuxbrew/.linuxbrew/bin/curl -X POST -H "Content-Type:multipart/form-data" -F "chat_id=${TELEGRAM_CHATID}" -F text="${myTextMessage} -$(date +%H:%M:%S)" "https://api.telegram.org/bot${TELEGRAM_BOTTOKEN}/sendMessage"
